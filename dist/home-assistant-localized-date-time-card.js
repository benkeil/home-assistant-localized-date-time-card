 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const B = globalThis, H = B.trustedTypes, Q = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, rt = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + f, vt = `<${ot}>`, m = document, C = () => m.createComment(""), P = (r) => r === null || typeof r != "object" && typeof r != "function", V = Array.isArray, bt = (r) => V(r) || typeof r?.[Symbol.iterator] == "function", j = `[ 	
...
const St = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = r[h];
    let c, p, l = -1, u = 0;
    for (; u < a.length && (n.lastIndex = u, p = n.exec(a), p !== null); ) u = n.lastIndex, n === S ? p[1] === "!--" ? n = X : p[1] !== void 0 ? n = Y : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = _) : p[3] !== void 0 && (n = _) : n === _ ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? _ : p[3] === '"' ? et : tt) : n === et || n === tt ? n = _ : n === X || n === Y ? n = S : (n = _, i = void 0);
    const $ = n === _ && r[h + 1].startsWith("/>") ? " " : "";
    o += n === S ? a + vt : l >= 0 ? (s.push(c), a.slice(0, l) + rt + a.slice(l) + f + $) : a + f + (l === -2 ? h : $);
  }
    ...
    for (; (i = g.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(rt)) {
          ...
          a.push({ type: 1, index: o, name: U[2], strings: $, ctor: U[1] === "." ? Ct : U[1] === "?" ? Pt : U[1] === "@" ? xt : R }), i.removeAttribute(l);
...
class wt {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let c;
        a.type === 2 ? c = new T(o, o.nextSibling, this, t) : a.type === 1 ? c = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (c = new Ot(o, this, t)), this._$AV.push(c), a = s[++h];
      }
...
class T {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s, i = 0;
    for (const o of t) i === e.length ? e.push(s = new T(this.O(C()), this.O(C()), this, this.options)) : s = e[i], s._$AI(o), i++;
...
let y = class extends v {
  ...
  render() {
    const r = this.getLocale(), t = {
      ...
      ...this.config.options
    }, e = this.getDateTime().toLocaleString(r, t);
    return at` <ha-card>
