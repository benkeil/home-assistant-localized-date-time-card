    ...
    for (; (i = g.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(rt)) {
          ...
          a.push({ type: 1, index: o, name: U[2], strings: $, ctor: U[1] === "." ? Ct : U[1] === "?" ? Pt : U[1] === "@" ? Ot : R }), i.removeAttribute(l);
...
class St {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let c;
        a.type === 2 ? c = new T(o, o.nextSibling, this, t) : a.type === 1 ? c = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (c = new xt(o, this, t)), this._$AV.push(c), a = s[++h];
      }
...
Tt?.(O, T), (B.litHtmlVersions ??= []).push("3.3.1");
const Ut = (r, t, e) => {
